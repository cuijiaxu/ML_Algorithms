...
DEFAULT_EDITION_PASSWORD = "heb_hygl_jcsj"
DEFAULT_EDITION_NAME = "hygl_jcsj"
DEFAULT_CONNECT_STRING = "10.1.30.26:1521/zdcomora"
DEFAULT_KL_STRING = "10.1.22.8:1521/zdcomora"
...
INSERT_USER = os.environ.get("CX_ORACLE_SAMPLES_MAIN_USER", DEFAULT_INSERT_USER)
INSERT_PASSWORD = os.environ.get("CX_ORACLE_SAMPLES_MAIN_PASSWORD",
        DEFAULT_INSERT_PASSWORD)
...
INSERT_MAIN_STRING = "%s/%s@%s" % (INSERT_USER, INSERT_PASSWORD, CONNECT_STRING)
